...
function addElement(loadingProj) {
  //if (loadingProj) {
    ...
    if (elementExists && !loadingProj) {
      ...
      <h3 class="title is-4" id="${"elementboxname" + $("#addElementNameBox").val()}">${$("#addElementNameBox").val()}</h3>
  ...
  //if (loadingProj) {
    ...
    if (assetExists && !loadingProj) {
      ...
      if (file) {
        ...
        center.innerHTML = `<h3 class="title is-4" id="${"elementboxname" + fileNameEncoded}">${fileName}</h3>`;
        previewBox = document.createElement("div");
